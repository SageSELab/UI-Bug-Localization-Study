...
export buggy_project_dir=Home/FaultLocalizationCode/Projects/BuggyProjects-round7
#export buggy_project_dir=UIBugLocalization/FaultLocalizationCode/Projects/BuggyProjects-round5
...
export filtered_boosted_files_in_repo=Home/FaultLocalizationCode/Projects/FilteredBoostedProjects-round7
...
export result_folder=results-round7 

#Final Results with the proper format will be saved here
export final_ranks_folder=../../FinalResultComputation/AllResults/Lucene-round7
