...
def get_all_java_files(bug_id):
    parent_directory = "/Users/junayed/Documents/NecessaryDocs/GeorgeMasonUniversity/Research/Projects/BugLocalization/Backup/BuggyProjects/bug-" + bug_id
    all_files = []
...
def create_xml_file(bug_id, bug_report_title, bug_report_content, xml_file, json_filepath):
    ...
    buggy_unique_file_list = get_all_java_files(bug_id)
    print(f"java : {len(buggy_unique_file_list)}")
